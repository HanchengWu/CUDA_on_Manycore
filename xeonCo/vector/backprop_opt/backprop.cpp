...
void bpnn_train_cuda(BPNN *net, float *eo, float *eh) {
  ...
  FILE *fpout = fopen("backprop_opt_nps3_vector_times.txt","a+");
  if(!fpout) {
  ...
  bpnn_layerforward_CUDA( affinity, usage, grid, threads_new, input_cuda, output_hidden_cuda, input_hidden_cuda, hidden_partial_sum, in, hid);
