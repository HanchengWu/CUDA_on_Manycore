...
extern "C" void bpnn_train_cuda(BPNN *net, float *eo, float *eh) {
  ...
  //FILE *fpout = fopen("backprop_opt_cuda_times.txt","a+");
  //FILE *fpout = fopen("backprop_times_cuda_nps2_c2070.txt","a+");
  FILE *fpout = fopen("backprop_opt_times_cuda_nps2_titan.txt","a+");
  if(!fpout) {
